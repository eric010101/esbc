...
// Page class
//
class sensor_basic_delete extends sensor_basic
{
	...
	// Page object name
	public $PageObjName = "sensor_basic_delete";
	...
	public function run()
	{
		...
		if ($filter == "")
			$this->terminate("sensor_basiclist.php"); // Prevent SQL injection, return to list
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("sensor_basiclist.php"); // Return to list
			}
		}
	}
