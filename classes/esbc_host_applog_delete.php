...
// Page class
//
class esbc_host_applog_delete extends esbc_host_applog
{
	...
	// Page object name
	public $PageObjName = "esbc_host_applog_delete";
	...
	public function run()
	{
		...
		if ($filter == "")
			$this->terminate("esbc_host_apploglist.php"); // Prevent SQL injection, return to list
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("esbc_host_apploglist.php"); // Return to list
			}
		}
	}
