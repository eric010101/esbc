...
class esbc_host_basic_add extends esbc_host_basic
{
	...
	protected function loadDefaultValues()
	{
		...
		$this->HOST_SERVERNAME->CurrentValue = NULL;
		$this->HOST_SERVERNAME->OldValue = $this->HOST_SERVERNAME->CurrentValue;
		...
		$this->HOST_RootDir->CurrentValue = "root";
		$this->HOST_RootLoginID->CurrentValue = NULL;
		$this->HOST_RootLoginID->OldValue = $this->HOST_RootLoginID->CurrentValue;
		$this->HOST_UseLocalHost->CurrentValue = 0;
		$this->HOST_BlockChainName->CurrentValue = "EqualSmart BlockChain Maker";
		$this->HOST_TokenName->CurrentValue = NULL;
		$this->HOST_TokenName->OldValue = $this->HOST_TokenName->CurrentValue;
		$this->HOST_TokenSymbol->CurrentValue = NULL;
		$this->HOST_TokenSymbol->OldValue = $this->HOST_TokenSymbol->CurrentValue;
		$this->HOST_TokenTotalSupply->CurrentValue = 200000000000;
		...
		$this->RPC_API->CurrentValue = "clique,admin,shh,personal,db,eth,net,web3,txpool,miner";
	...
	protected function newRow()
	{
		...
		$row['HOST_SERVERNAME'] = $this->HOST_SERVERNAME->CurrentValue;
		$row['HOST_IP'] = $this->HOST_IP->CurrentValue;
		$row['HOST_PW'] = $this->HOST_PW->CurrentValue;
		$row['HOST_RootDir'] = $this->HOST_RootDir->CurrentValue;
		$row['HOST_RootLoginID'] = $this->HOST_RootLoginID->CurrentValue;
		$row['HOST_UseLocalHost'] = $this->HOST_UseLocalHost->CurrentValue;
		$row['HOST_BlockChainName'] = $this->HOST_BlockChainName->CurrentValue;
		$row['HOST_TokenName'] = $this->HOST_TokenName->CurrentValue;
		$row['HOST_TokenSymbol'] = $this->HOST_TokenSymbol->CurrentValue;
		$row['HOST_TokenTotalSupply'] = $this->HOST_TokenTotalSupply->CurrentValue;
		...
		$row['RPC_API'] = $this->RPC_API->CurrentValue;
	...
	protected function addRow($rsold = NULL)
	{
		...
		// HOST_SERVERNAME
		$this->HOST_SERVERNAME->setDbValueDef($rsnew, $this->HOST_SERVERNAME->CurrentValue, "", FALSE);

		// HOST_IP
		$this->HOST_IP->setDbValueDef($rsnew, $this->HOST_IP->CurrentValue, "", FALSE);

		// HOST_PW
		$this->HOST_PW->setDbValueDef($rsnew, $this->HOST_PW->CurrentValue, NULL, strval($this->HOST_PW->CurrentValue) == "");

		// HOST_RootDir
		$this->HOST_RootDir->setDbValueDef($rsnew, $this->HOST_RootDir->CurrentValue, "", strval($this->HOST_RootDir->CurrentValue) == "");

		// HOST_RootLoginID
		$this->HOST_RootLoginID->setDbValueDef($rsnew, $this->HOST_RootLoginID->CurrentValue, "", FALSE);

		// HOST_UseLocalHost
		$this->HOST_UseLocalHost->setDbValueDef($rsnew, $this->HOST_UseLocalHost->CurrentValue, 0, strval($this->HOST_UseLocalHost->CurrentValue) == "");

		// HOST_BlockChainName
		$this->HOST_BlockChainName->setDbValueDef($rsnew, $this->HOST_BlockChainName->CurrentValue, "", strval($this->HOST_BlockChainName->CurrentValue) == "");

		// HOST_TokenName
		$this->HOST_TokenName->setDbValueDef($rsnew, $this->HOST_TokenName->CurrentValue, NULL, FALSE);

		// HOST_TokenSymbol
		$this->HOST_TokenSymbol->setDbValueDef($rsnew, $this->HOST_TokenSymbol->CurrentValue, NULL, FALSE);

		// HOST_TokenTotalSupply
		$this->HOST_TokenTotalSupply->setDbValueDef($rsnew, $this->HOST_TokenTotalSupply->CurrentValue, NULL, strval($this->HOST_TokenTotalSupply->CurrentValue) == "");

		// NODENAME_ARRAY
		$this->NODENAME_ARRAY->setDbValueDef($rsnew, $this->NODENAME_ARRAY->CurrentValue, "", strval($this->NODENAME_ARRAY->CurrentValue) == "");

		// PW_ARRAY
		$this->PW_ARRAY->setDbValueDef($rsnew, $this->PW_ARRAY->CurrentValue, "", strval($this->PW_ARRAY->CurrentValue) == "");

		// MYSQL_OWNER
		$this->MYSQL_OWNER->setDbValueDef($rsnew, $this->MYSQL_OWNER->CurrentValue, "", strval($this->MYSQL_OWNER->CurrentValue) == "");

		// MYSQL_PW
		$this->MYSQL_PW->setDbValueDef($rsnew, $this->MYSQL_PW->CurrentValue, "", strval($this->MYSQL_PW->CurrentValue) == "");

		// FTP_OWNER
		$this->FTP_OWNER->setDbValueDef($rsnew, $this->FTP_OWNER->CurrentValue, NULL, strval($this->FTP_OWNER->CurrentValue) == "");

		// FTP_PW
		$this->FTP_PW->setDbValueDef($rsnew, $this->FTP_PW->CurrentValue, "", strval($this->FTP_PW->CurrentValue) == "");
		...
		// RPC_API
		$this->RPC_API->setDbValueDef($rsnew, $this->RPC_API->CurrentValue, "", strval($this->RPC_API->CurrentValue) == "");
