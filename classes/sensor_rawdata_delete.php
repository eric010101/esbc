...
// Page class
//
class sensor_rawdata_delete extends sensor_rawdata
{
	...
	// Page object name
	public $PageObjName = "sensor_rawdata_delete";
	...
	public function run()
	{
		...
		if ($filter == "")
			$this->terminate("sensor_rawdatalist.php"); // Prevent SQL injection, return to list
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("sensor_rawdatalist.php"); // Return to list
			}
		}
	}
