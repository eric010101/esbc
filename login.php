...
?>
<script>
$(".social-auth-links a").click(function(e) {
	ew.alert("Feature disabled on this demo site. Please read help file on how to enable the feature and test on your server.");
	e.preventDefault();
});
</script>
