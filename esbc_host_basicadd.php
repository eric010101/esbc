...
fesbc_host_basicadd.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php } ?>
		<?php if ($esbc_host_basic_add->HOST_SERVERNAME->Required) { ?>
		...
		<?php } ?>
		<?php if ($esbc_host_basic_add->HOST_RootDir->Required) { ?>
		...
		<?php } ?>
		<?php if ($esbc_host_basic_add->HOST_RootLoginID->Required) { ?>
		...
		<?php } ?>
		<?php if ($esbc_host_basic_add->HOST_UseLocalHost->Required) { ?>
		...
		<?php if ($esbc_host_basic_add->HOST_BlockChainName->Required) { ?>
		...
		<?php } ?>
		<?php if ($esbc_host_basic_add->HOST_TokenName->Required) { ?>
		...
		<?php } ?>
		<?php if ($esbc_host_basic_add->HOST_TokenSymbol->Required) { ?>
		...
		<?php } ?>
		<?php if ($esbc_host_basic_add->HOST_TokenTotalSupply->Required) { ?>
		...
		<?php if ($esbc_host_basic_add->RPC_API->Required) { ?>
...
<?php if ($esbc_host_basic->HOST_SERVERNAME->Visible) { // HOST_SERVERNAME ?>
	<div id="r_HOST_SERVERNAME" class="form-group row">
		<label id="elh_esbc_host_basic_HOST_SERVERNAME" for="x_HOST_SERVERNAME" class="<?php echo $esbc_host_basic_add->LeftColumnClass ?>"><?php echo $esbc_host_basic->HOST_SERVERNAME->caption() ?><?php echo ($esbc_host_basic->HOST_SERVERNAME->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $esbc_host_basic_add->RightColumnClass ?>"><div<?php echo $esbc_host_basic->HOST_SERVERNAME->cellAttributes() ?>>
...
<?php if ($esbc_host_basic->HOST_RootDir->Visible) { // HOST_RootDir ?>
	<div id="r_HOST_RootDir" class="form-group row">
		<label id="elh_esbc_host_basic_HOST_RootDir" for="x_HOST_RootDir" class="<?php echo $esbc_host_basic_add->LeftColumnClass ?>"><?php echo $esbc_host_basic->HOST_RootDir->caption() ?><?php echo ($esbc_host_basic->HOST_RootDir->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $esbc_host_basic_add->RightColumnClass ?>"><div<?php echo $esbc_host_basic->HOST_RootDir->cellAttributes() ?>>
...
<?php if ($esbc_host_basic->HOST_RootLoginID->Visible) { // HOST_RootLoginID ?>
	<div id="r_HOST_RootLoginID" class="form-group row">
		<label id="elh_esbc_host_basic_HOST_RootLoginID" for="x_HOST_RootLoginID" class="<?php echo $esbc_host_basic_add->LeftColumnClass ?>"><?php echo $esbc_host_basic->HOST_RootLoginID->caption() ?><?php echo ($esbc_host_basic->HOST_RootLoginID->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $esbc_host_basic_add->RightColumnClass ?>"><div<?php echo $esbc_host_basic->HOST_RootLoginID->cellAttributes() ?>>
...
<?php if ($esbc_host_basic->HOST_UseLocalHost->Visible) { // HOST_UseLocalHost ?>
	<div id="r_HOST_UseLocalHost" class="form-group row">
		<label id="elh_esbc_host_basic_HOST_UseLocalHost" for="x_HOST_UseLocalHost" class="<?php echo $esbc_host_basic_add->LeftColumnClass ?>"><?php echo $esbc_host_basic->HOST_UseLocalHost->caption() ?><?php echo ($esbc_host_basic->HOST_UseLocalHost->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $esbc_host_basic_add->RightColumnClass ?>"><div<?php echo $esbc_host_basic->HOST_UseLocalHost->cellAttributes() ?>>
...
<?php if ($esbc_host_basic->HOST_BlockChainName->Visible) { // HOST_BlockChainName ?>
	<div id="r_HOST_BlockChainName" class="form-group row">
		<label id="elh_esbc_host_basic_HOST_BlockChainName" for="x_HOST_BlockChainName" class="<?php echo $esbc_host_basic_add->LeftColumnClass ?>"><?php echo $esbc_host_basic->HOST_BlockChainName->caption() ?><?php echo ($esbc_host_basic->HOST_BlockChainName->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $esbc_host_basic_add->RightColumnClass ?>"><div<?php echo $esbc_host_basic->HOST_BlockChainName->cellAttributes() ?>>
...
<?php if ($esbc_host_basic->HOST_TokenName->Visible) { // HOST_TokenName ?>
	<div id="r_HOST_TokenName" class="form-group row">
		<label id="elh_esbc_host_basic_HOST_TokenName" for="x_HOST_TokenName" class="<?php echo $esbc_host_basic_add->LeftColumnClass ?>"><?php echo $esbc_host_basic->HOST_TokenName->caption() ?><?php echo ($esbc_host_basic->HOST_TokenName->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $esbc_host_basic_add->RightColumnClass ?>"><div<?php echo $esbc_host_basic->HOST_TokenName->cellAttributes() ?>>
...
<?php if ($esbc_host_basic->HOST_TokenSymbol->Visible) { // HOST_TokenSymbol ?>
	<div id="r_HOST_TokenSymbol" class="form-group row">
		<label id="elh_esbc_host_basic_HOST_TokenSymbol" for="x_HOST_TokenSymbol" class="<?php echo $esbc_host_basic_add->LeftColumnClass ?>"><?php echo $esbc_host_basic->HOST_TokenSymbol->caption() ?><?php echo ($esbc_host_basic->HOST_TokenSymbol->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $esbc_host_basic_add->RightColumnClass ?>"><div<?php echo $esbc_host_basic->HOST_TokenSymbol->cellAttributes() ?>>
...
<?php if ($esbc_host_basic->HOST_TokenTotalSupply->Visible) { // HOST_TokenTotalSupply ?>
	<div id="r_HOST_TokenTotalSupply" class="form-group row">
		<label id="elh_esbc_host_basic_HOST_TokenTotalSupply" for="x_HOST_TokenTotalSupply" class="<?php echo $esbc_host_basic_add->LeftColumnClass ?>"><?php echo $esbc_host_basic->HOST_TokenTotalSupply->caption() ?><?php echo ($esbc_host_basic->HOST_TokenTotalSupply->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $esbc_host_basic_add->RightColumnClass ?>"><div<?php echo $esbc_host_basic->HOST_TokenTotalSupply->cellAttributes() ?>>
...
<?php if ($esbc_host_basic->RPC_API->Visible) { // RPC_API ?>
	<div id="r_RPC_API" class="form-group row">
		<label id="elh_esbc_host_basic_RPC_API" for="x_RPC_API" class="<?php echo $esbc_host_basic_add->LeftColumnClass ?>"><?php echo $esbc_host_basic->RPC_API->caption() ?><?php echo ($esbc_host_basic->RPC_API->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $esbc_host_basic_add->RightColumnClass ?>"><div<?php echo $esbc_host_basic->RPC_API->cellAttributes() ?>>
