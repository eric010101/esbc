...
// Create page object
$sensor_rawdata_edit = new sensor_rawdata_edit();

// Run the page
$sensor_rawdata_edit->run();
...
$sensor_rawdata_edit->Page_Render();
?>
...
var fsensor_rawdataedit = currentForm = new ew.Form("fsensor_rawdataedit", "edit");

// Validate form
fsensor_rawdataedit.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php if ($sensor_rawdata_edit->RTLindex->Required) { ?>
			elm = this.getElements("x" + infix + "_RTLindex");
			if (elm && !ew.isHidden(elm) && !ew.hasValue(elm))
				return this.onError(elm, "<?php echo JsEncode(str_replace("%s", $sensor_rawdata->RTLindex->caption(), $sensor_rawdata->RTLindex->RequiredErrorMessage)) ?>");
		<?php } ?>
		<?php if ($sensor_rawdata_edit->imei->Required) { ?>
		...
		<?php } ?>
		<?php if ($sensor_rawdata_edit->GPS_lat->Required) { ?>
		...
		<?php if ($sensor_rawdata_edit->GPS_lon->Required) { ?>
		...
		<?php if ($sensor_rawdata_edit->timezone->Required) { ?>
		...
		<?php } ?>
		<?php if ($sensor_rawdata_edit->sensor_id->Required) { ?>
		...
		<?php } ?>
		<?php if ($sensor_rawdata_edit->sensor_value->Required) { ?>
		...
		<?php if ($sensor_rawdata_edit->sensor_unit->Required) { ?>
		...
		<?php } ?>
		<?php if ($sensor_rawdata_edit->date_add->Required) { ?>
		...
		<?php if ($sensor_rawdata_edit->blockn->Required) { ?>
		...
		<?php } ?>
		<?php if ($sensor_rawdata_edit->BlockDetail->Required) { ?>
...
fsensor_rawdataedit.Form_CustomValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
...
fsensor_rawdataedit.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;
...
<?php $sensor_rawdata_edit->showPageHeader(); ?>
<?php
$sensor_rawdata_edit->showMessage();
?>
<form name="fsensor_rawdataedit" id="fsensor_rawdataedit" class="<?php echo $sensor_rawdata_edit->FormClassName ?>" action="<?php echo CurrentPageName() ?>" method="post">
<?php if ($sensor_rawdata_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $sensor_rawdata_edit->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="sensor_rawdata">
<input type="hidden" name="action" id="action" value="update">
<input type="hidden" name="modal" value="<?php echo (int)$sensor_rawdata_edit->IsModal ?>">
<div class="ew-edit-div"><!-- page* -->
<?php if ($sensor_rawdata->RTLindex->Visible) { // RTLindex ?>
	<div id="r_RTLindex" class="form-group row">
		<label id="elh_sensor_rawdata_RTLindex" class="<?php echo $sensor_rawdata_edit->LeftColumnClass ?>"><?php echo $sensor_rawdata->RTLindex->caption() ?><?php echo ($sensor_rawdata->RTLindex->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $sensor_rawdata_edit->RightColumnClass ?>"><div<?php echo $sensor_rawdata->RTLindex->cellAttributes() ?>>
<span id="el_sensor_rawdata_RTLindex">
<span<?php echo $sensor_rawdata->RTLindex->viewAttributes() ?>>
<input type="text" readonly class="form-control-plaintext" value="<?php echo RemoveHtml($sensor_rawdata->RTLindex->EditValue) ?>"></span>
</span>
<input type="hidden" data-table="sensor_rawdata" data-field="x_RTLindex" name="x_RTLindex" id="x_RTLindex" value="<?php echo HtmlEncode($sensor_rawdata->RTLindex->CurrentValue) ?>">
<?php echo $sensor_rawdata->RTLindex->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($sensor_rawdata->imei->Visible) { // imei ?>
	<div id="r_imei" class="form-group row">
		<label id="elh_sensor_rawdata_imei" for="x_imei" class="<?php echo $sensor_rawdata_edit->LeftColumnClass ?>"><?php echo $sensor_rawdata->imei->caption() ?><?php echo ($sensor_rawdata->imei->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $sensor_rawdata_edit->RightColumnClass ?>"><div<?php echo $sensor_rawdata->imei->cellAttributes() ?>>
...
<?php if ($sensor_rawdata->GPS_lat->Visible) { // GPS_lat ?>
	<div id="r_GPS_lat" class="form-group row">
		<label id="elh_sensor_rawdata_GPS_lat" for="x_GPS_lat" class="<?php echo $sensor_rawdata_edit->LeftColumnClass ?>"><?php echo $sensor_rawdata->GPS_lat->caption() ?><?php echo ($sensor_rawdata->GPS_lat->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $sensor_rawdata_edit->RightColumnClass ?>"><div<?php echo $sensor_rawdata->GPS_lat->cellAttributes() ?>>
...
<?php if ($sensor_rawdata->GPS_lon->Visible) { // GPS_lon ?>
	<div id="r_GPS_lon" class="form-group row">
		<label id="elh_sensor_rawdata_GPS_lon" for="x_GPS_lon" class="<?php echo $sensor_rawdata_edit->LeftColumnClass ?>"><?php echo $sensor_rawdata->GPS_lon->caption() ?><?php echo ($sensor_rawdata->GPS_lon->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $sensor_rawdata_edit->RightColumnClass ?>"><div<?php echo $sensor_rawdata->GPS_lon->cellAttributes() ?>>
...
<?php if ($sensor_rawdata->timezone->Visible) { // timezone ?>
	<div id="r_timezone" class="form-group row">
		<label id="elh_sensor_rawdata_timezone" for="x_timezone" class="<?php echo $sensor_rawdata_edit->LeftColumnClass ?>"><?php echo $sensor_rawdata->timezone->caption() ?><?php echo ($sensor_rawdata->timezone->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $sensor_rawdata_edit->RightColumnClass ?>"><div<?php echo $sensor_rawdata->timezone->cellAttributes() ?>>
...
<?php if ($sensor_rawdata->sensor_id->Visible) { // sensor_id ?>
	<div id="r_sensor_id" class="form-group row">
		<label id="elh_sensor_rawdata_sensor_id" for="x_sensor_id" class="<?php echo $sensor_rawdata_edit->LeftColumnClass ?>"><?php echo $sensor_rawdata->sensor_id->caption() ?><?php echo ($sensor_rawdata->sensor_id->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $sensor_rawdata_edit->RightColumnClass ?>"><div<?php echo $sensor_rawdata->sensor_id->cellAttributes() ?>>
...
<?php if ($sensor_rawdata->sensor_value->Visible) { // sensor_value ?>
	<div id="r_sensor_value" class="form-group row">
		<label id="elh_sensor_rawdata_sensor_value" for="x_sensor_value" class="<?php echo $sensor_rawdata_edit->LeftColumnClass ?>"><?php echo $sensor_rawdata->sensor_value->caption() ?><?php echo ($sensor_rawdata->sensor_value->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $sensor_rawdata_edit->RightColumnClass ?>"><div<?php echo $sensor_rawdata->sensor_value->cellAttributes() ?>>
...
<?php if ($sensor_rawdata->sensor_unit->Visible) { // sensor_unit ?>
	<div id="r_sensor_unit" class="form-group row">
		<label id="elh_sensor_rawdata_sensor_unit" for="x_sensor_unit" class="<?php echo $sensor_rawdata_edit->LeftColumnClass ?>"><?php echo $sensor_rawdata->sensor_unit->caption() ?><?php echo ($sensor_rawdata->sensor_unit->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $sensor_rawdata_edit->RightColumnClass ?>"><div<?php echo $sensor_rawdata->sensor_unit->cellAttributes() ?>>
...
<?php if ($sensor_rawdata->date_add->Visible) { // date_add ?>
	<div id="r_date_add" class="form-group row">
		<label id="elh_sensor_rawdata_date_add" for="x_date_add" class="<?php echo $sensor_rawdata_edit->LeftColumnClass ?>"><?php echo $sensor_rawdata->date_add->caption() ?><?php echo ($sensor_rawdata->date_add->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $sensor_rawdata_edit->RightColumnClass ?>"><div<?php echo $sensor_rawdata->date_add->cellAttributes() ?>>
...
<script>
ew.createDateTimePicker("fsensor_rawdataedit", "x_date_add", {"ignoreReadonly":true,"useCurrent":false,"format":1});
</script>
<?php } ?>
</span>
...
<?php if ($sensor_rawdata->blockn->Visible) { // blockn ?>
	<div id="r_blockn" class="form-group row">
		<label id="elh_sensor_rawdata_blockn" for="x_blockn" class="<?php echo $sensor_rawdata_edit->LeftColumnClass ?>"><?php echo $sensor_rawdata->blockn->caption() ?><?php echo ($sensor_rawdata->blockn->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $sensor_rawdata_edit->RightColumnClass ?>"><div<?php echo $sensor_rawdata->blockn->cellAttributes() ?>>
...
<?php if ($sensor_rawdata->BlockDetail->Visible) { // BlockDetail ?>
	<div id="r_BlockDetail" class="form-group row">
		<label id="elh_sensor_rawdata_BlockDetail" for="x_BlockDetail" class="<?php echo $sensor_rawdata_edit->LeftColumnClass ?>"><?php echo $sensor_rawdata->BlockDetail->caption() ?><?php echo ($sensor_rawdata->BlockDetail->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $sensor_rawdata_edit->RightColumnClass ?>"><div<?php echo $sensor_rawdata->BlockDetail->cellAttributes() ?>>
...
<?php if (!$sensor_rawdata_edit->IsModal) { ?>
<div class="form-group row"><!-- buttons .form-group -->
	<div class="<?php echo $sensor_rawdata_edit->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ew-btn" name="btn-action" id="btn-action" type="submit"><?php echo $Language->Phrase("SaveBtn") ?></button>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" data-href="<?php echo $sensor_rawdata_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<?php
$sensor_rawdata_edit->showPageFooter();
if (DEBUG_ENABLED)
