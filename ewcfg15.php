...
define(PROJECT_NAMESPACE . "PROJECT_NAME", "esbc_clientALL_20181122"); // Project name
define(PROJECT_NAMESPACE . "CONFIG_FILE_FOLDER", PROJECT_NAME); // Config file name
define(PROJECT_NAMESPACE . "PROJECT_ID", "{04503673-A70B-421F-8E02-1DFE5D0B56A3}"); // Project ID (GUID)
define(PROJECT_NAMESPACE . "RANDOM_KEY", '7tTpF6ri0mcFpYvg'); // Random key for encryption
define(PROJECT_NAMESPACE . "ENCRYPTION_KEY", ''); // Encryption key for data protection
define(PROJECT_NAMESPACE . "PROJECT_STYLESHEET_FILENAME", "phpcss/esbc_clientALL_20181122.css"); // Project stylesheet file name
