...
// Create page object
$esbc_host_applog_edit = new esbc_host_applog_edit();

// Run the page
$esbc_host_applog_edit->run();
...
$esbc_host_applog_edit->Page_Render();
?>
...
var fesbc_host_applogedit = currentForm = new ew.Form("fesbc_host_applogedit", "edit");

// Validate form
fesbc_host_applogedit.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php if ($esbc_host_applog_edit->LOG_INDEX->Required) { ?>
			elm = this.getElements("x" + infix + "_LOG_INDEX");
			if (elm && !ew.isHidden(elm) && !ew.hasValue(elm))
				return this.onError(elm, "<?php echo JsEncode(str_replace("%s", $esbc_host_applog->LOG_INDEX->caption(), $esbc_host_applog->LOG_INDEX->RequiredErrorMessage)) ?>");
		<?php } ?>
		<?php if ($esbc_host_applog_edit->NICK_NAME->Required) { ?>
		...
		<?php } ?>
		<?php if ($esbc_host_applog_edit->HOST_IP->Required) { ?>
		...
		<?php } ?>
		<?php if ($esbc_host_applog_edit->HOST_ROOT_ID->Required) { ?>
		...
		<?php } ?>
		<?php if ($esbc_host_applog_edit->HOST_ROOT_PWD->Required) { ?>
		...
		<?php } ?>
		<?php if ($esbc_host_applog_edit->ACC40_PWD->Required) { ?>
		...
		<?php } ?>
		<?php if ($esbc_host_applog_edit->ACC40->Required) { ?>
		...
		<?php } ?>
		<?php if ($esbc_host_applog_edit->ENODE->Required) { ?>
		...
		<?php } ?>
		<?php if ($esbc_host_applog_edit->GENESIS->Required) { ?>
		...
		<?php } ?>
		<?php if ($esbc_host_applog_edit->GETH_CMD->Required) { ?>
		...
		<?php } ?>
		<?php if ($esbc_host_applog_edit->HOST_CONFIG_LOG->Required) { ?>
		...
		<?php } ?>
		<?php if ($esbc_host_applog_edit->B18_LOG->Required) { ?>
		...
		<?php } ?>
		<?php if ($esbc_host_applog_edit->_1F_LOG->Required) { ?>
		...
		<?php } ?>
		<?php if ($esbc_host_applog_edit->Create_Date->Required) { ?>
		...
		<?php if ($esbc_host_applog_edit->ACTIVE->Required) { ?>
		...
		<?php } ?>
		<?php if ($esbc_host_applog_edit->Modify_Date->Required) { ?>
...
fesbc_host_applogedit.Form_CustomValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
...
fesbc_host_applogedit.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fesbc_host_applogedit.lists["x_ACTIVE"] = <?php echo $esbc_host_applog_edit->ACTIVE->Lookup->toClientList() ?>;
fesbc_host_applogedit.lists["x_ACTIVE"].options = <?php echo JsonEncode($esbc_host_applog_edit->ACTIVE->options(FALSE, TRUE)) ?>;
...
<?php $esbc_host_applog_edit->showPageHeader(); ?>
<?php
$esbc_host_applog_edit->showMessage();
?>
<form name="fesbc_host_applogedit" id="fesbc_host_applogedit" class="<?php echo $esbc_host_applog_edit->FormClassName ?>" action="<?php echo CurrentPageName() ?>" method="post">
<?php if ($esbc_host_applog_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $esbc_host_applog_edit->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="esbc_host_applog">
<input type="hidden" name="action" id="action" value="update">
<input type="hidden" name="modal" value="<?php echo (int)$esbc_host_applog_edit->IsModal ?>">
<div class="ew-edit-div"><!-- page* -->
<?php if ($esbc_host_applog->LOG_INDEX->Visible) { // LOG_INDEX ?>
	<div id="r_LOG_INDEX" class="form-group row">
		<label id="elh_esbc_host_applog_LOG_INDEX" class="<?php echo $esbc_host_applog_edit->LeftColumnClass ?>"><?php echo $esbc_host_applog->LOG_INDEX->caption() ?><?php echo ($esbc_host_applog->LOG_INDEX->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $esbc_host_applog_edit->RightColumnClass ?>"><div<?php echo $esbc_host_applog->LOG_INDEX->cellAttributes() ?>>
<span id="el_esbc_host_applog_LOG_INDEX">
<span<?php echo $esbc_host_applog->LOG_INDEX->viewAttributes() ?>>
<input type="text" readonly class="form-control-plaintext" value="<?php echo RemoveHtml($esbc_host_applog->LOG_INDEX->EditValue) ?>"></span>
</span>
<input type="hidden" data-table="esbc_host_applog" data-field="x_LOG_INDEX" name="x_LOG_INDEX" id="x_LOG_INDEX" value="<?php echo HtmlEncode($esbc_host_applog->LOG_INDEX->CurrentValue) ?>">
<?php echo $esbc_host_applog->LOG_INDEX->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($esbc_host_applog->NICK_NAME->Visible) { // NICK_NAME ?>
	<div id="r_NICK_NAME" class="form-group row">
		<label id="elh_esbc_host_applog_NICK_NAME" for="x_NICK_NAME" class="<?php echo $esbc_host_applog_edit->LeftColumnClass ?>"><?php echo $esbc_host_applog->NICK_NAME->caption() ?><?php echo ($esbc_host_applog->NICK_NAME->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $esbc_host_applog_edit->RightColumnClass ?>"><div<?php echo $esbc_host_applog->NICK_NAME->cellAttributes() ?>>
...
<?php if ($esbc_host_applog->HOST_IP->Visible) { // HOST_IP ?>
	<div id="r_HOST_IP" class="form-group row">
		<label id="elh_esbc_host_applog_HOST_IP" for="x_HOST_IP" class="<?php echo $esbc_host_applog_edit->LeftColumnClass ?>"><?php echo $esbc_host_applog->HOST_IP->caption() ?><?php echo ($esbc_host_applog->HOST_IP->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $esbc_host_applog_edit->RightColumnClass ?>"><div<?php echo $esbc_host_applog->HOST_IP->cellAttributes() ?>>
...
<?php if ($esbc_host_applog->HOST_ROOT_ID->Visible) { // HOST_ROOT_ID ?>
	<div id="r_HOST_ROOT_ID" class="form-group row">
		<label id="elh_esbc_host_applog_HOST_ROOT_ID" for="x_HOST_ROOT_ID" class="<?php echo $esbc_host_applog_edit->LeftColumnClass ?>"><?php echo $esbc_host_applog->HOST_ROOT_ID->caption() ?><?php echo ($esbc_host_applog->HOST_ROOT_ID->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $esbc_host_applog_edit->RightColumnClass ?>"><div<?php echo $esbc_host_applog->HOST_ROOT_ID->cellAttributes() ?>>
...
<?php if ($esbc_host_applog->HOST_ROOT_PWD->Visible) { // HOST_ROOT_PWD ?>
	<div id="r_HOST_ROOT_PWD" class="form-group row">
		<label id="elh_esbc_host_applog_HOST_ROOT_PWD" for="x_HOST_ROOT_PWD" class="<?php echo $esbc_host_applog_edit->LeftColumnClass ?>"><?php echo $esbc_host_applog->HOST_ROOT_PWD->caption() ?><?php echo ($esbc_host_applog->HOST_ROOT_PWD->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $esbc_host_applog_edit->RightColumnClass ?>"><div<?php echo $esbc_host_applog->HOST_ROOT_PWD->cellAttributes() ?>>
...
<?php if ($esbc_host_applog->ACC40_PWD->Visible) { // ACC40_PWD ?>
	<div id="r_ACC40_PWD" class="form-group row">
		<label id="elh_esbc_host_applog_ACC40_PWD" for="x_ACC40_PWD" class="<?php echo $esbc_host_applog_edit->LeftColumnClass ?>"><?php echo $esbc_host_applog->ACC40_PWD->caption() ?><?php echo ($esbc_host_applog->ACC40_PWD->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $esbc_host_applog_edit->RightColumnClass ?>"><div<?php echo $esbc_host_applog->ACC40_PWD->cellAttributes() ?>>
...
<?php if ($esbc_host_applog->ACC40->Visible) { // ACC40 ?>
	<div id="r_ACC40" class="form-group row">
		<label id="elh_esbc_host_applog_ACC40" for="x_ACC40" class="<?php echo $esbc_host_applog_edit->LeftColumnClass ?>"><?php echo $esbc_host_applog->ACC40->caption() ?><?php echo ($esbc_host_applog->ACC40->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $esbc_host_applog_edit->RightColumnClass ?>"><div<?php echo $esbc_host_applog->ACC40->cellAttributes() ?>>
...
<?php if ($esbc_host_applog->ENODE->Visible) { // ENODE ?>
	<div id="r_ENODE" class="form-group row">
		<label id="elh_esbc_host_applog_ENODE" for="x_ENODE" class="<?php echo $esbc_host_applog_edit->LeftColumnClass ?>"><?php echo $esbc_host_applog->ENODE->caption() ?><?php echo ($esbc_host_applog->ENODE->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $esbc_host_applog_edit->RightColumnClass ?>"><div<?php echo $esbc_host_applog->ENODE->cellAttributes() ?>>
...
<?php if ($esbc_host_applog->GENESIS->Visible) { // GENESIS ?>
	<div id="r_GENESIS" class="form-group row">
		<label id="elh_esbc_host_applog_GENESIS" for="x_GENESIS" class="<?php echo $esbc_host_applog_edit->LeftColumnClass ?>"><?php echo $esbc_host_applog->GENESIS->caption() ?><?php echo ($esbc_host_applog->GENESIS->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $esbc_host_applog_edit->RightColumnClass ?>"><div<?php echo $esbc_host_applog->GENESIS->cellAttributes() ?>>
...
<?php if ($esbc_host_applog->GETH_CMD->Visible) { // GETH_CMD ?>
	<div id="r_GETH_CMD" class="form-group row">
		<label id="elh_esbc_host_applog_GETH_CMD" for="x_GETH_CMD" class="<?php echo $esbc_host_applog_edit->LeftColumnClass ?>"><?php echo $esbc_host_applog->GETH_CMD->caption() ?><?php echo ($esbc_host_applog->GETH_CMD->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $esbc_host_applog_edit->RightColumnClass ?>"><div<?php echo $esbc_host_applog->GETH_CMD->cellAttributes() ?>>
...
<?php if ($esbc_host_applog->HOST_CONFIG_LOG->Visible) { // HOST_CONFIG_LOG ?>
	<div id="r_HOST_CONFIG_LOG" class="form-group row">
		<label id="elh_esbc_host_applog_HOST_CONFIG_LOG" for="x_HOST_CONFIG_LOG" class="<?php echo $esbc_host_applog_edit->LeftColumnClass ?>"><?php echo $esbc_host_applog->HOST_CONFIG_LOG->caption() ?><?php echo ($esbc_host_applog->HOST_CONFIG_LOG->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $esbc_host_applog_edit->RightColumnClass ?>"><div<?php echo $esbc_host_applog->HOST_CONFIG_LOG->cellAttributes() ?>>
...
<?php if ($esbc_host_applog->B18_LOG->Visible) { // B18_LOG ?>
	<div id="r_B18_LOG" class="form-group row">
		<label id="elh_esbc_host_applog_B18_LOG" for="x_B18_LOG" class="<?php echo $esbc_host_applog_edit->LeftColumnClass ?>"><?php echo $esbc_host_applog->B18_LOG->caption() ?><?php echo ($esbc_host_applog->B18_LOG->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $esbc_host_applog_edit->RightColumnClass ?>"><div<?php echo $esbc_host_applog->B18_LOG->cellAttributes() ?>>
...
<?php if ($esbc_host_applog->_1F_LOG->Visible) { // 1F_LOG ?>
	<div id="r__1F_LOG" class="form-group row">
		<label id="elh_esbc_host_applog__1F_LOG" for="x__1F_LOG" class="<?php echo $esbc_host_applog_edit->LeftColumnClass ?>"><?php echo $esbc_host_applog->_1F_LOG->caption() ?><?php echo ($esbc_host_applog->_1F_LOG->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $esbc_host_applog_edit->RightColumnClass ?>"><div<?php echo $esbc_host_applog->_1F_LOG->cellAttributes() ?>>
...
<?php if ($esbc_host_applog->Create_Date->Visible) { // Create_Date ?>
	<div id="r_Create_Date" class="form-group row">
		<label id="elh_esbc_host_applog_Create_Date" for="x_Create_Date" class="<?php echo $esbc_host_applog_edit->LeftColumnClass ?>"><?php echo $esbc_host_applog->Create_Date->caption() ?><?php echo ($esbc_host_applog->Create_Date->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $esbc_host_applog_edit->RightColumnClass ?>"><div<?php echo $esbc_host_applog->Create_Date->cellAttributes() ?>>
...
<script>
ew.createDateTimePicker("fesbc_host_applogedit", "x_Create_Date", {"ignoreReadonly":true,"useCurrent":false,"format":1});
</script>
<?php } ?>
</span>
...
<?php if ($esbc_host_applog->ACTIVE->Visible) { // ACTIVE ?>
	<div id="r_ACTIVE" class="form-group row">
		<label id="elh_esbc_host_applog_ACTIVE" for="x_ACTIVE" class="<?php echo $esbc_host_applog_edit->LeftColumnClass ?>"><?php echo $esbc_host_applog->ACTIVE->caption() ?><?php echo ($esbc_host_applog->ACTIVE->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $esbc_host_applog_edit->RightColumnClass ?>"><div<?php echo $esbc_host_applog->ACTIVE->cellAttributes() ?>>
...
<?php if ($esbc_host_applog->Modify_Date->Visible) { // Modify_Date ?>
	<div id="r_Modify_Date" class="form-group row">
		<label id="elh_esbc_host_applog_Modify_Date" for="x_Modify_Date" class="<?php echo $esbc_host_applog_edit->LeftColumnClass ?>"><?php echo $esbc_host_applog->Modify_Date->caption() ?><?php echo ($esbc_host_applog->Modify_Date->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $esbc_host_applog_edit->RightColumnClass ?>"><div<?php echo $esbc_host_applog->Modify_Date->cellAttributes() ?>>
...
<script>
ew.createDateTimePicker("fesbc_host_applogedit", "x_Modify_Date", {"ignoreReadonly":true,"useCurrent":false,"format":1});
</script>
<?php } ?>
</span>
...
<?php if (!$esbc_host_applog_edit->IsModal) { ?>
<div class="form-group row"><!-- buttons .form-group -->
	<div class="<?php echo $esbc_host_applog_edit->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ew-btn" name="btn-action" id="btn-action" type="submit"><?php echo $Language->Phrase("SaveBtn") ?></button>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" data-href="<?php echo $esbc_host_applog_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<?php
$esbc_host_applog_edit->showPageFooter();
if (DEBUG_ENABLED)
...
<?php
$esbc_host_applog_edit->terminate();
?>
