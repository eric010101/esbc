...
<?php } ?>
<link rel="shortcut icon" type="image/x-icon" href="<?php echo $RELATIVE_PATH ?>equalsmart.ico"><link rel="icon" type="image/x-icon" href="<?php echo $RELATIVE_PATH ?>equalsmart.ico">
...
<div class="wrapper ew-layout">
	...
	<nav class="<?php echo $NAVBAR_CLASS ?>">
		...
		<ul class="nav-item" style="font-size: 20px;"> $ESBC_HEADTITLE$ </ul>
		<!-- Right navbar links -->
	...
	<aside class="<?php echo $SIDEBAR_CLASS ?>">
		...
		<a href="#" class="brand-link">
			<span class="brand-text">ChainMaker 2019</span>
		</a>
		<!-- Sidebar -->
		<div class="sidebar">
			<!-- Sidebar Menu -->
